...
用户选择走 Phase 2（易用性)。**已完成 2.6 HTML 报告**（插队优先,`review --html`,minijinja + base64 内联截图 + 报告噪声去重)。Phase 2 剩余:2.1 一键 `check`、2.2 `specprobe.toml`、2.3 进度条、2.4 运行归档/SQLite、2.5 审批持久化。
